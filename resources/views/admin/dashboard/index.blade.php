                ...
                <div class="card card-refresh">
                    ...
                    <div class="card-header card-header-action">
                        <div>
                            ...
                            <p class="font-14 w-80">Lorem ipsum dolor sit amet, consectetur adipiscing
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="hk-legend-wrap mt-20">
                            <div class="hk-legend">
                                <span
                                    class="d-10 bg-sky-light-3 rounded-circle d-inline-block"></span><span>18-24</span>
                            </div>
                            <div class="hk-legend">
                                <span
                                    class="d-10 bg-sky-light-4 rounded-circle d-inline-block"></span><span>25-34</span>
                            </div>
                            <div class="hk-legend">
                                <span
                                    class="d-10 bg-sky-light-5 rounded-circle d-inline-block"></span><span>35-44</span>
                            </div>
                            <div class="hk-legend">
                                <span
                                    class="d-10 bg-sky-light-2 rounded-circle d-inline-block"></span><span>45-54</span>
                            </div>
                            <div class="hk-legend">
                                        ...
                                        <div class="media position-absolute b-0 l-0 align-items-center">
                                            <div class="media-img-wrap d-flex mr-15">
                                                <div class="avatar avatar-sm">
                                                    <span
                                                        class="avatar-text avatar-text-inv-yellow rounded-circle"><span
                                ...
                                <div class="position-relative z-index-2 pa-20">
                                    <div class="position-relative text-white mnh-225p">
                                        ...
                                        <div class="media position-absolute b-0 l-0 align-items-center">
                                            <div class="media-img-wrap d-flex mr-15">
                                                <div class="avatar avatar-sm">
                                                    <span class="avatar-text avatar-text-inv-green rounded-circle"><span
                    ...
                    <div class="card-body">
                        <div class="user-activity user-activity-sm">
                            ...
                            <div class="media">
                                <div class="media-img-wrap">
                                    <div class="avatar avatar-xs">
                                        <img src="img/avatar3.jpg" alt="user" class="avatar-img rounded-circle">
                                    </div>
                                </div>
                                <div class="media-body">
                                    <div>
                                    ...
                                    <div class="d-flex">
                                        <a href="#" class="w-75p mr-10"><img class="card-img-top rounded"
                                                src="img/slide1.jpg" alt="Card image cap"></a>
                                        <a href="#" class="w-75p mr-10"><img class="card-img-top rounded"
                                                src="img/slide2.jpg" alt="Card image cap"></a>
                                        <a href="#" class="w-75p mr-10"><img class="card-img-top rounded"
                                                src="img/slide3.jpg" alt="Card image cap"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="media">
                                <div class="media-img-wrap">
                                    <div class="avatar avatar-xs">
                                        <img src="img/avatar4.jpg" alt="user" class="avatar-img rounded-circle">
                                    </div>
                                </div>
                                <div class="media-body">
                                    <div>
